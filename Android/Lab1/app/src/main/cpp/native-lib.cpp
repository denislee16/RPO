...
Java_com_example_lab1_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_lab1_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_lab1_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data) {
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
...
//Java_com_example_lab1_MainActivity_transaction(JNIEnv *env, jobject thiz, jbyteArray trd) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_lab1_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd) {
